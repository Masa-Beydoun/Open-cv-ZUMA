        ...
        while True:
            ...
            if game_region:
                ...
                if result_data and result_data.get("mask") is not None:
                    ...
                    global_path = [
                        (lx + x, ly + y) for (lx, ly) in result_data.get("path", [])
                    ]
                    ...
                    temp_mask = cv2.morphologyEx(
                        raw_mask, cv2.MORPH_CLOSE, kernel_close
                    )
                    ...
                    path_mask = cv2.dilate(
                        clean_single_mask, kernel_dilate, iterations=3
                    )
...
if __name__ == "__main__":
    points, mask = capture_game_path(ZUMA_DELUXE_CONFIG)
